...
public final class JDBCExample25 {
    @NotNull
    ...
    @NotNull
    private HashMap propertieses = new HashMap();
    ...
    @NotNull
    public final HashMap getPropertieses() {
        return this.propertieses;
    }

    public final void setPropertieses(@NotNull HashMap var1) {
        Intrinsics.checkParameterIsNotNull(var1, "<set-?>");
        this.propertieses = var1;
    }
    ...
    public final void getBlockData(@NotNull String from, @NotNull String where, @NotNull String order, @NotNull String offset, @NotNull String select) {
        ...
        try {
            ...
            if (Intrinsics.areEqual(offset, "") ^ true) {
                sql = sql + " LIMIT 25 OFFSET " + offset;
            }
            ...
            while(rss.next()) {
                ...
                int var12 = var10000.getColumnCount();
                if (i <= var12) {
                    while(true) {
                        String var13 = rss.getMetaData().getColumnName(i);
                        System.out.println(var13);
                        var13 = rss.getString(i);
                        System.out.println(var13);
                ...
                this.propertieses.put(j, new HashMap((Map)this.properties));
                ++j;
                char var26 = '\n';
    ...
    // $FF: synthetic method
    public static void getBlockData$default(JDBCExample25 var0, String var1, String var2, String var3, String var4, String var5, int var6, Object var7) {
        if ((var6 & 1) != 0) {
            var1 = "blockdata";
        }
